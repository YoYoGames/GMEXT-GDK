...
:: Setup the GDK Environment (force version Update Jun 2024)
call "C:\Program Files (x86)\Microsoft GDK\Command Prompts\GamingDesktopVars.cmd" GamingDesktopVS2022 %GDK_VERSION%
if ERRORLEVEL 1 (
